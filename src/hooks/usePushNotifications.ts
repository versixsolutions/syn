...
const VAPID_PUBLIC_KEY =
  "BKEj4ZZVnsI-ctNxQBN4hrDUoP2NKntKJ_or3NU5QTYUJSsZAsUdTaKkD-yO_zo7tYUDMbbye2kvMuxQGk611Ns";
...
export function usePushNotifications() {
  ...
  async function subscribe() {
    ...
    try {
      ...
      setIsSubscribed(true);
      alert(
        "Notificações ativadas com sucesso! Você receberá alertas de novos comunicados.",
      );
    } catch (error: any) {
